    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommonTypeReferences", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_CommonTypeReferences_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "CommonTypeReferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Users_CommonTypeReferences_RoleId",
                        column: x => x.RoleId,
                        principalTable: "CommonTypeReferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelDetails_CommonTypeReferences_MealPreferenceId",
                        column: x => x.MealPreferenceId,
                        principalTable: "CommonTypeReferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_HotelDetails_CommonTypeReferences_NoOfMealsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportDetails_CommonTypeReferences_TravelFromId",
                        column: x => x.TravelFromId,
                        principalTable: "CommonTypeReferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_TransportDetails_CommonTypeReferences_TravelToId",
